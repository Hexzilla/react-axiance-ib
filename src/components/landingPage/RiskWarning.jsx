  ...
  return (
    <div className="risk-warning-parent">
      ...
      >
        ...
        {/* <p
          className="risk-warning-para"
          style={width <= 700 ? { marginRight: '30px' } : {}}
        >
          <span className="risk-warning-heading">
            {t('topRiskWarning.topRiskWarningTitle')}
            :
          </span>
          {t('topRiskWarning.topRiskWarningMessage')}
        </p> */}
        {width <= 700 && (
